...
public class ClasificadorBY extends javax.swing.JFrame {
    ...
    String[] nuevorow;
    String[] c1 = new String[]{"Litchies","0","0","1900","300","45","5","0"};
    String[] c2 = new String[]{"Rambutan","1800","482","10","8","0","0","0"};
    String[] c3 = new String[]{"Jocotes","0","0","0","0","50","400","2000"};
    ...
    private void initComponents() {
        ...
        Titul2.setForeground(new java.awt.Color(255, 255, 255));
        ...
        Titul1.setForeground(new java.awt.Color(255, 255, 255));
    ...
    public void Clasificar()
    {
        ...
        /*
        for(int i=0;i<(f-fi);i++)
        {
        System.out.println("Valor ln: "+valor[i][0]);
        System.out.println("Valor clase: "+(int)valor[i][1]);
        }
        */
        //System.out.println("Pertence a la clase #:"+NumberNear.GetClass(valor,(f-fi)));
        
        //(String)dtm2.getValueAt(i,0);
